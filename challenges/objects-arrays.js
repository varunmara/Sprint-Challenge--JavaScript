...
let tyrannosaurus = new Dinosaur({name: "tyrannosaurus", diet: "carnivorous", weight: "7000kg", length: "12m", period = "Late Crataceous"})

tyrannosaurus.roar = function () {
  return "RAWERSRARARWERSARARARRRR!";
};

let stegosaurus = new Dinosaur({name: "stegosaurus", diet: "herbivorous", weight: "2000kg", length: "9m", period = "Late Jurassic"})

let velociraptor = new Dinosaur({name: "velociraptor", diet: "carnivorous", weight: "15kg", length: "1.8m", period = "Late Crataceous"})
...
const unisWithUni = graduates.filter(item => item.university.contains('Uni'));
